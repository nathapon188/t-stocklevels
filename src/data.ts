...
const items: Omit<StockItem, 'id' | 'stock'>[] = [
  ...
  { name: 'Bacon(Rindless Middle)', unit: 'kg', max: 10, category: 'Cafe' },
  ...
  { name: 'Beetroot Dip', unit: 'kg', max: 5, category: 'Condiments' },
  { name: 'Margarine Spread', unit: 'kg', max: 5, category: 'Condiments' },
  { name: 'Mayonnaise', unit: 'kg', max: 5, category: 'Condiments' },
  ...
  { name: '9oz PET U Cold Cup (275ml)', unit: 'pcs', max: 100, category: 'Packaging Items', subgroup: 'Trays & Containers' },
  { name: '10oz PET U Cold Cup (300ml)', unit: 'pcs', max: 100, category: 'Packaging Items', subgroup: 'Trays & Containers' },
  ...
  { name: 'Gloves (S)', unit: 'pcs', max: 100, category: 'Packaging Items', subgroup: 'Trays & Containers' },
  { name: 'Gloves (M)', unit: 'pcs', max: 100, category: 'Packaging Items', subgroup: 'Trays & Containers' },
  { name: 'Gloves (L)', unit: 'pcs', max: 100, category: 'Packaging Items', subgroup: 'Trays & Containers' },
